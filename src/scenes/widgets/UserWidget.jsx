import {
  ...
  const UserWidget = ({ userId, picturePath }) => {
    ...
    const getUser = async () => {
        //recuperer l'utilisateur logged on apartir de son id pour afficher ses infos 
    ...
    //lorsqu'on charge la page on fait appel a  getUser() pour recuperer l'info de user
    useEffect(() => {
        getUser();
      }, []);
